...
<!--            <div id="gauge"  class="ring-charts"></div>-->
        ...
        <div class="equipment-right">
            <ul class="equipment-list">
                ...
                <li class="equipment-list-tr" :key="index" v-for="(item,index) in config.data">
                    <span>{{item[0]}}</span>
                    <span>{{item[1]}}</span>
                    <span>{{item[2]}}</span>
    ...
    export default {
        ...
        data(){
            return{
                ...
                config: {
                    header: ['名称', '地点', '原因', '发生故障时间', '故障次数', '故障等级'],
                    data: [
                        ['tipss_controller_066_1','066车1车厢','设备断电','2020/08/31 22:22:22','1','低'],
                        ['tipss_controller_066_2','066车1车厢','设备断电','2020/08/31 22:22:22','1','低'],
                        ['tipss_controller_066_3','066车1车厢','设备断电','2020/08/31 22:22:22','1','低'],
                        ['tipss_controller_066_4','066车1车厢','设备断电','2020/08/31 22:22:22','1','低'],
                        ['tipss_controller_066_5','066车1车厢','设备断电','2020/08/31 22:22:22','1','低'],
                    ],
                    index: true,
                    ...
                    series: [
                        {
                            ...
                            arcLineWidth: 16,
                            data: [
                                { value: 65, gradient: ['#03c2fd', '#1ed3e5', '#2fded6'] }
                            ],
                            axisLabel: {
                                show: false
                            },
